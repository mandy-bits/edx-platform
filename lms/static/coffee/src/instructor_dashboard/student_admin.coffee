...
class StudentAdmin
  constructor: (@$section) ->
    ...
    @$progress_link.click (e) =>
      ...
      translated_error_message = _.template(error_message, {student_id: unique_student_identifier})
      ...
      $.ajax
        ...
        error: std_ajax_err => @$request_response_error_progress.text translated_error_message
    ...
    @$btn_reset_attempts_single.click =>
      ...
      translated_success_message = _.template(success_message, {problem_id: problem_to_reset, student_id: unique_student_identifier})
      translated_error_message = _.template(error_message, {problem_id: problem_to_reset, student_id: unique_student_identifier})

      $.ajax
        dataType: 'json'
        url: @$btn_reset_attempts_single.data 'endpoint'
        data: send_data
        success: @clear_errors_then -> alert translated_success_message
        error: std_ajax_err => @$request_response_error_grade.text translated_error_message
    ...
    @$btn_delete_state_single.click =>
      ...
      translated_confirm_message = _.template(confirm_message, {student_id: unique_student_identifier, problem_id: problem_to_reset})

      if window.confirm translated_confirm_message
        send_data =
          unique_student_identifier: unique_student_identifier
          problem_to_reset: problem_to_reset
          delete_module: true
        ...
        translated_error_message = _.template(error_message, {student_id: unique_student_identifier, problem_id: problem_to_reset})
    ...
    @$btn_rescore_problem_single.click =>
      ...
      translated_success_message = _.template(success_message, {student_id: unique_student_identifier, problem_id: problem_to_reset})
    ...
    @$btn_reset_attempts_all.click =>
      ...
      translated_confirm_message = _.template(confirm_message, {problem_id: problem_to_reset})
      if window.confirm translated_confirm_message
        send_data =
          all_students: true
          problem_to_reset: problem_to_reset
        ...
        translated_success_message = _.template(success_message, {problem_id: problem_to_reset})
        ...
        translated_error_message = _.template(error_message, {problem_id: problem_to_reset})
        ...
        $.ajax
          ...
          data: send_data
          success: @clear_errors_then -> alert translated_success_message
          error: std_ajax_err => @$request_response_error_all.text translated_error_message
      else
        # Clear error messages if "Cancel" was chosen on confirmation alert
        @clear_errors()
